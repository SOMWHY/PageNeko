...
const arr_pageNeko_down_left = ["CUR_DOWN_LEFT_FRAME01.png", "CUR_DOWN_LEFT_FRAME02.png"];
const arr_pageNeko_down_right = ["CUR_DOWN_RIGHT_FRAME01.png", "CUR_DOWN_RIGHT_FRAME02.png"];
...
const arr_pageNeko_up_left = ["CUR_UP_LEFT_FRAME01.png", "CUR_UP_LEFT_FRAME02.png"];
const arr_pageNeko_up_right = ["CUR_UP_RIGHT_FRAME01.png", "CUR_UP_RIGHT_FRAME02.png"];
const arr_pageNeko_surprised = ["CUR_SURPRISE_FRAME01.png", "CUR_SURPRISE_FRAME02.png"];
const arr_pageNeko_idle = ["CUR_IDLE_FRAME01.png", "CUR_IDLE_FRAME02.png"];
const arr_pageNeko_idling = ["CUR_IDLING_FRAME01.png", "CUR_IDLING_FRAME02.png"];
const arr_pageNeko_sleep_start = ["CUR_SLEEPSTART_FRAME01.png", "CUR_SLEEPSTART_FRAME02.png"];
const arr_pageNeko_sleeping = ["CUR_SLEEP_FRAME01.png", "CUR_SLEEP_FRAME02.png"];

// Scratching (all directions)
const arr_pageNeko_scratch_down = ["CUR_SCRATCH_DOWN_FRAME01.png", "CUR_SCRATCH_DOWN_FRAME02.png"];
const arr_pageNeko_scratch_left = ["CUR_SCRATCH_LEFT_FRAME01.png", "CUR_SCRATCH_LEFT_FRAME02.png"];
const arr_pageNeko_scratch_right = ["CUR_SCRATCH_RIGHT_FRAME01.png", "CUR_SCRATCH_RIGHT_FRAME02.png"];
const arr_pageNeko_scratch_up = ["CUR_SCRATCH_UP_FRAME01.png", "CUR_SCRATCH_UP_FRAME02.png"];
